    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-17">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <a class="mr-1 w-7 bg-indigo-600 hover:bg-indigo-800 rounded-full flex flex-col justify-center items-center text-sm font-extrabolg text-white"
