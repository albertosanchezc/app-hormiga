...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('pantallas', function (Blueprint $table) {
            ...
            $table->foreignId('estado_id')->nullable()->constrained()->restrictOnDelete();//dado que los estados es algo sumamente crítico en el sistema se optó por no dar la opción de borrarlos
